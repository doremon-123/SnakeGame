#snake game
#part 2: moving direction
#part 3: food
# part 4 : snake body using list
#part 5:Border checking
import turtle
import time
import random
delay=0.1
...
#set up the screen
wn=turtle.Screen()
wn.title("Snake game by Manisha Murmu")
wn.bgcolor("green")
...
while True:
    ...
    #check for head collision with the body segmentd
    for segment in segments:
